              ...
              <table class="custom-border" border="1" cellspacing="0" width="500px" height="160px" bgcolor="white">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 33.333%; text-align: center; color: black; font-size:16px"
                  ...
                  <tr>
                    <td colspan="3" style="color: black; font-size:16px"><span
                        class="option-percentages-container">&nbsp;&nbsp;&nbsp;&nbsp;正确人数比：{{
                          questionData[question]?.optionPercentages || '0' }}</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
